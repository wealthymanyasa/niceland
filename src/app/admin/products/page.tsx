...
import { Plus, Search, Edit, Trash2, Filter, Download, Upload, Package, TrendingUp, TrendingDown } from 'lucide-react'
...
export default function AdminProducts() {
  ...
  const categories = ['all', 'running', 'basketball', 'lifestyle', 'training', 'walking']
  const stats = {
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center mb-8 gap-4">
            <div className="flex flex-col sm:flex-row gap-4 flex-1">
              ...
              <select
                ...
                className="px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 bg-white"
              >
            ...
            <div className="text-center py-16">
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-4">
                  {searchTerm || selectedCategory !== 'all' ? 'No products match your filters.' : 'Start by adding your first product.'}
                </p>
